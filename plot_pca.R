data=read.table("TEST.major.hapmap3r2.pruned.pca.evec",h=F,skip=1) ###change file name to your own here
cont=which(data$V4=="Control")
case=which(data$V4=="Case")
CEU=which(data$V4=="3")
CHB=which(data$V4=="4")
JPT=which(data$V4=="5")
YRI=which(data$V4=="6")
pdf("pca-ancestry-plot.pdf")
plot(data$V1,data$V2,xlim=c(-0.1,0.05),ylim=c(-0.05,0.1),xlab="principal component 1", ylab="principal component 2")
